...
python -m pip install "cdxml-toolkit-community[windows,office,chemscript,publication] @ git+https://github.com/ZiChenWang114514/cdxml-toolkit-community.git@89c843bc027383030994557f9908b44985c2cf72"
```
